...
Original file is located at
    https://colab.research.google.com/drive/1iUenVi0-bIenckGZHVd49SczgW5nXqtu
...
DATA_PATH = Path(__file__).resolve().parents[1] / "data" / "raw" / "W1_Pokemon.csv"
...
fig1 = px.box(df, x="Type 1", y="Speed", color="Type 1", notched=True, points='all')
fig1.show()

sns.kdeplot(x=df.Defense, y=df.HP, fill=True , thresh=0.01, cbar=True);
plt.title('Defense vs HP')

fig2 = px.density_contour(df, x="Defense", y="HP")
